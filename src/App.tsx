	...
	return (
		<Router>
			<Routes>
				...
				<Route path='/body-type-result' element={<BodyTypeResult />} />
				<Route
					path='/tops'
					element={<CategoryPage title='Tops' nextRoute='/bottoms' />}
				/>
				<Route
					path='/bottoms'
					element={
						<CategoryPage title='Bottoms' nextRoute='/dresses' />
					}
				/>
				<Route
					path='/dresses'
				...
				<Route
					path='/layers'
					element={<CategoryPage title='Layers' nextRoute='/bags' />}
				/>
				<Route
					path='/bags'
					element={
